  ...
  return (
    <section className="flex justify-wrap items-center max-xl:flex-col-reverse gap-10 max-container">
     ...
     <div className="flex--1">
      <img src={offer} alt="discount img"
        width={773}
        height={687}
      ...
      <div className="flex flex-1 flex-col">
          ...
          Embark on a shopping journey that redfines your experience with unbetable deals. from premier selection to incredible value that sets ud apart.  
          </p>
